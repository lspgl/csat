...
def make_test_ellipse(center=[1, 1], width=1, height=.6, phi=3.14 / 5):
    ...
    ellipse_x = center[0] + width * numpy.cos(t) * numpy.cos(phi) - height * \
        numpy.sin(t) * numpy.sin(phi) + x_noise / 2.
    ellipse_y = center[1] + width * numpy.cos(t) * numpy.sin(phi) + height * \
        numpy.sin(t) * numpy.cos(phi) + y_noise / 2.
